...
exports.sleep = exports.clone = exports.getSpaceUri = exports.validateSchema = exports.getScores = exports.sendTransaction = exports.ipfsGet = exports.getUrl = exports.subgraphRequest = exports.multicall = exports.call = exports.SNAPSHOT_SUBGRAPH_URL = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cross_fetch_1["default"](scoreApiUrl, {
                            method: 'POST',
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    hash = hash_1.namehash(id);
                    provider = provider_1["default"]('1');
...
exports.getSpaceUri = getSpaceUri;
function clone(item) {
